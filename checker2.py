#!/usr/bin/env python3
"""Proxy Checker v2 - Multi-threaded proxy validator"""
...
if __name__ == '__main__':
    if len(sys.argv) != 4:
        print(f"Usage: python3 {sys.argv[0]} <proxy_file> <output_file> <timeout>")
        print("Example: python3 checker2.py proxies.txt valid.txt 5000")
        sys.exit(1)
